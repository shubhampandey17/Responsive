"use client"
import FrameComponent from "./(dashboard)/frame-omponent";
...
export default function Home ()  {
  ...
  return (
    <div className="flex justify-center items-center">
      <div className="w-full h-fit relative bg-slate-200 overflow-hidden flex flex-col items-center justify-center font-poppins tracking-[normal] rounded-2xl mx-9 my-9 text-center" >
          ...
          <div className="self-stretch flex flex-col items-start justify-start pt-[70.09999999999991px] px-[45px] pb-[111px] box-border relative gap-[69px] max-w-full mq1300:pt-[46px] mq1300:px-[22px] mq1300:pb-[72px] mq1300:box-border mq450:gap-[17px_69px] mq900:gap-[34px_69px] mq900:pt-[30px] mq900:pb-[47px] mq900:box-border">
            ...
            <div className="flex flex-col items-start justify-start gap-[64px] max-w-full text-3xl text-black mq450:gap-[16px_64px] mq900:gap-[32px_64px]">
              <div className="flex flex-row items-end justify-center gap-[61px] max-w-full mq450:gap-[61px_15px] mq900:gap-[61px_30px] mq1650:flex-wrap">
                <div className="w-[494px] rounded-xl bg-orange-200 flex flex-col items-start justify-start pt-[43px] px-[179px] pb-[45px] box-border gap-[19px] max-w-full z-[1] mq450:pl-[89px] mq450:pr-[89px] mq450:box-border">
                  ...
                  <div className="w-[105px] flex flex-row items-start justify-start">
                    <div className="h-[105px] flex-1 relative">
                      ...
                      <img
                        className="absolute top-[23px] left-[25px] w-[60px] h-[59px] object-cover z-[3] cursor-pointer"
                        loading="lazy"
                        alt=""
                        src="/chat-1@2x.png"
                    ...
                    <div className="w-[191px] flex flex-row items-start justify-start py-0 px-[43px] box-border">
                      <div className="flex-1 flex flex-row items-start justify-start z-[2]">
                        <div className="h-[105px] flex-1 relative">
                          ...
                          <img
                            className="absolute top-[18px] left-[18px] w-[70px] h-[69px] object-cover z-[1] cursor-pointer"
                            loading="lazy"
                            alt=""
                ...
                <div className="w-[494px] rounded-xl bg-silver flex flex-col items-center justify-start pt-[30px] pb-[50px] pr-5 pl-[21px] box-border gap-[27px] max-w-full z-[1]">
              ...
              <div className="flex flex-row items-start justify-center gap-[60px] max-w-full mq900:gap-[60px_30px] mq1650:flex-wrap">
                <FrameComponent report="/report@2x.png" reports="Reports" onClick={handleReportsClick} />
                <FrameComponent
                ...
                />
                <div className="w-[494px] rounded-xl bg-lightgray-100 flex flex-col items-center justify-start pt-12 pb-[41px] pr-5 pl-[26px] box-border gap-[18px] max-w-full z-[1]">
                  ...
                  <div className="w-[132px] flex flex-row items-start justify-start py-0 pr-[17px] pl-2.5 box-border">
                    <div className="flex-1 flex flex-row items-start justify-start z-[1]">
                      <div className="h-[105px] flex-1 relative">
                        <div className="absolute top-[0px] left-[0px] rounded-[50%] bg-white w-full h-full" />
                        <img
                          className="absolute top-[11px] left-[17px] w-[72px] h-[72px] object-cover z-[1] cursor-pointer"
                          loading="lazy"
                          alt=""
                          src="/users@2x.png"
